...
class CreateClassescontrolesmatieresTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('classescontrolesmatieres', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('classescontrolesmatieres');
    }
}
