...
@section('content')
{{ Breadcrumbs::render('admin.parametre.semestres') }}
    ...
    <div class="container-fluid">
        <div class="row">
            <section class="content" style="margin:auto;">
                            ...
                            <h4 style="font-style:italic;margin-left: -512px; margin-bottom: -29px; color: #007bff;">{{__('text.Semestres.list')}}</h4>
                   
                          <div><a class="'btn btn-success" style="padding: 6px;float:right; margin-right: -518px;"
                                    href="{{ route('semestres.create') }}"> &nbsp; <i
                                        class="right fas fa-plus-circle"> &nbsp;</i>{{__('text.Semestres.add')}}</a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align:right;">
                                    <form method="delete"  action="{{route('semestres.destroy', $item->id)}}">
                                       
            

                                        @csrf
                                        @method('DELETE')
                                        <div class='btn-group'><a href="{{ route('semestres.edit', $item->id) }}"
