...
<!-- start add Modal -->
{{ Breadcrumbs::render('admin.affectations.classesniveauxfilieres.add') }}


        <div class="modal-header">
          <h5 style= "font-style:italic ;color: #007bff;" class="modal-title" id="exampleModalLabel">{{__('text.ClassesNiveauxFilieres.add')}}</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          </button>


        </div>
      <form action="{{ action('ClassesNiveauxFilieresController@store') }}" method="POST">
