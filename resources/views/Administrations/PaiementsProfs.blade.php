...
<div class="content-header">
  ...
  <div class="input-group-prepend">
    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" style="margin:auto; margin-left: 700px;
    margin-bottom: 20px;
  ...
  <div class="input-group-prepend">
    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" style="margin:auto; margin-left: 870px;
    margin-bottom: 20px;
    background-color: #343a40;
    color: whitesmoke;">
      Annees Scolaire
            ...
            <div class="col-12">
              <div class="card" style="background-color: #343a40; margin-bottom: 0px;">
                <div class="card-header"><strong><em><h4 style=" position: absolute;
                  color: antiquewhite; margin-top: 8px;"> Listes Paiements Profs</h4></em></strong>
