...
<!-- start edit Modal -->
{{ Breadcrumbs::render('admin.parametre.controles.edit',$data->id) }}



            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel" style="font-style:italic; color: #007bff; ">{{__('text.Controles.edit')}}</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                </button>


            </div>
            <form action="{{ route('controles.update', [$data->id]) }}" method="POST">
